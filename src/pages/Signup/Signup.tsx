  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        <div className="min-w-screen min-h-screen w-3/4 mx-auto flex items-center justify-center px-5 py-5">
          <div className="bg-gray-100 text-gray-700 rounded-sm shadow-xl w-full overflow-hidden">
            <div className="md:flex w-full">
              <div className="hidden md:block w-1/2 bg-sky-950 py-10 px-10">
                <svg
                ...
                >
                  ...
                  />
                  <path
                    d="M846.12661,580.70047a10.52561,10.52561,0,0,1,1.70061.70389l44.34832-22.1972.736-12.02551,18.2938-1.26127.98041,27.4126L852.7199,592.93235a10.4958,10.4958,0,1,1-6.59329-12.23188Z"
                    transform="translate(-227.576 -76.46149)"
                    fill="#ffb8b8"
                  />
                  <path
                ...
                <div>
                    ...
                    <div className="w-1/2 px-3 mb-5">
                      ...
                      <div className="flex">
                        ...
                        <input
                          name="firstName"
                          type="text"
                          className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-slate-700"
                          placeholder="John"
                        />
                      </div>
                    </div>
                  ...
                  <div className="flex -mx-3">
                    <div className="w-full px-3 mb-5">
                      <button
                        type="submit"
                        className="block w-full max-w-xs mx-auto bg-slate-700 hover:bg-slate-900 focus:bg-slate-700 text-white rounded-lg px-3 py-3 font-semibold"
                      >
                        REGISTER NOW
                      </button>
                    </div>
