        ...
        >
          ...
          <nav className="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto ">
            ...
            <div>
              <ul>
                {/* <li className="mb-1">
                                    <NavLink className="block p-4 text-sm font-semibold text-inherit hover:bg-blue-50 hover:text-blue-600 rounded" >Home</NavLink>
                                </li>
                                <li className="mb-1">
                                    <NavLink className="block p-4 text-sm font-semibold text-inherit hover:bg-blue-50 hover:text-blue-600 rounded" >About Us</NavLink>
                                </li>
                                <li className="mb-1">
                                    <NavLink className="block p-4 text-sm font-semibold text-inherit hover:bg-blue-50 hover:text-blue-600 rounded" >Services</NavLink>
                                </li>
                                <li className="mb-1">
                                    <NavLink className="block p-4 text-sm font-semibold text-inherit hover:bg-blue-50 hover:text-blue-600 rounded" >Pricing</NavLink>
                                </li>
                                <li className="mb-1">
                                    <NavLink className="block p-4 text-sm font-semibold text-inherit hover:bg-blue-50 hover:text-blue-600 rounded" >Contact</NavLink>
                                </li> */}
            ...
            <div className="mt-auto">
              <div className="pt-6">
                {/* <NavLink className="block px-4 py-3 mb-3  text-xs text-center font-semibold leading-none bg-gray-50 hover:bg-gray-100 rounded-xl" >Sign in</NavLink>
              ...
              <p className="my-4 text-xs text-center text-inherit">
